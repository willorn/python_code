...
![img](https://q-1306233034.cos.ap-guangzhou.myqcloud.com/company/1653887348928-cc2280ad-1606-4248-a32f-f9a072f42534.gif?tximg)
...
![img](https://q-1306233034.cos.ap-guangzhou.myqcloud.com/company/1654497165664-9eed4c23-cdd7-4765-812f-f253b4b9103e.png?tximg)

1. offset：需要更正的地址位置偏移量，相对于该节的开始处
2. type：主要分为两类

3. 1. R 386 PC32：Relocate a reference that uses a 32-bit PC-relative address.（使用32位的PC相对位置偏移重定位一个引用）
   2. R 386 32：Relocate a reference that uses a 32-bit absolute address.（使用32位的绝对地址重定位一个引用）

4. symbol：symtab的下标，用于指定符号，通过中间层可以让 值的存储可以高度自定义，包括编码等一系列信息都可以通过在另一张表中进行实现
5. addend：对修改时做偏移调整



![img](https://q-1306233034.cos.ap-guangzhou.myqcloud.com/company/1654498861600-c135a998-5542-4a5a-a78b-e1059d2c7790.png?tximg)
...
![img](https://q-1306233034.cos.ap-guangzhou.myqcloud.com/company/1654505441201-566ef113-98fc-49e3-81d6-5f252a2ecbd7.png?tximg)

**链接时打桩:**

通过在命令行输入命令实现函数调用的更改

![img](https://q-1306233034.cos.ap-guangzhou.myqcloud.com/company/1654505530611-2dc8e4c7-cc78-4792-a34f-bba8ebfc06a5.png?tximg)
